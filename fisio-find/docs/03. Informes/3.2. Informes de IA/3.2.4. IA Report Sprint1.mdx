---
title: "Informe de IA del #SPRINT 1"
...
<h1 align="center" style={{ fontSize: "30px", fontWeight: "bold" }}>
  FISIO FIND - INFORME DE IA #SPRINT 1
</h1>
...
1. **Desempeño positivo pero polarizado:** predominan las puntuaciones altas, pero hay una parte significativa de resultados bajos.
2. **Correlación moderada:** más prompts pueden llevar a mejores resultados, pero no es una regla.
3. **Diversidad en interacciones:** mucha variabilidad en la longitud de las conversaciones.
4. **Dispersión importante:** tanto en puntuaciones como en número de prompts, reflejando un uso muy heterogéneo.
