...
$$
\begin{aligned}
r &= \frac{7 \cdot 77 - 28 \cdot 21}{\sqrt{(7 \cdot 116 - 28^2)(7 \cdot 113 - 21^2)}} \\
  &= \frac{539 - 588}{\sqrt{(812 - 784)(791 - 441)}} \\
  &= \frac{-49}{\sqrt{28 \cdot 350}} \\
  &= \frac{-49}{\sqrt{9800}} \\
  &\approx \frac{-49}{98.99} \approx -0.4949
\end{aligned}
$$
