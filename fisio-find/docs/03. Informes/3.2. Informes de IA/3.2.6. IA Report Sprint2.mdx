...
$$
\begin{aligned}
&\sum x = 85,\ \sum y = 142,\ \sum xy = 672,\ \sum x^2 = 385,\ \sum y^2 = 1490 \\
&r = \frac{22 \cdot 672 - 85 \cdot 142}{\sqrt{(22 \cdot 385 - 85^2)(22 \cdot 1490 - 142^2)}} \\
&r = \frac{14784 - 12070}{\sqrt{(8470 - 7225)(32780 - 20164)}} \approx \frac{2714}{\sqrt{1245 \cdot 12616}} \approx 0.22
\end{aligned}
$$

**Resultado:** Correlación **0.22** (positiva débil)
...
$$
\begin{aligned}
&\sum x = 61,\ \sum y = 358,\ \sum xy = 258,\ \sum x^2 = 301,\ \sum y^2 = 25858 \\
&r = \frac{15 \cdot 258 - 61 \cdot 358}{\sqrt{(15 \cdot 301 - 61^2)(15 \cdot 25858 - 358^2)}} \\
&r = \frac{3870 - 21838}{\sqrt{(4515 - 3721)(387870 - 128164)}} \approx \frac{-17968}{\sqrt{794 \cdot 259706}} \approx -0.88
\end{aligned}
$$

**Resultado:** Correlación **-0.88** (negativa fuerte)
...
$$
\begin{aligned}
&\sum x = 133,\ \sum y = 358,\ \sum xy = 1358,\ \sum x^2 = 1889,\ \sum y^2 = 25858 \\
&r = \frac{15 \cdot 1358 - 133 \cdot 358}{\sqrt{(15 \cdot 1889 - 133^2)(15 \cdot 25858 - 358^2)}} \approx -0.11
\end{aligned}
$$

**Resultado:** Correlación **-0.11** (negativa muy débil)
