---
title: "Mid Term Retrospective (14/03-27/03)"  # CHANGE IF NEEDED
...
<h1 align="center" style={{ fontSize: "30px", fontWeight: "bold" }}>
  FISIO FIND  -  MID TERM RETROSPECTIVE
</h1>
---
...
- **Contribuidores:** [Daniel Alors Romero](https://github.com/DanielAlors) (autor), [Francisco Mateos Villarejo](https://github.com/pacomateos10) (autor), [Miguel Encina Martínez](https://github.com/MiguelEncina) (revisor) 
...
|------------|---------|----------------------------------|----------------------------|
| 15/03/2025 | v1.0    | Daniel Alors Romero,  Francisco Mateos Villarejo | Elaboración de la primera versión del documento |
...
| Daniel Alors Romero | 28% | X | 10% | 30% | 30% | E |
...
| Julen Redondo Pacheco | 27% | X | 10% | 30% | 30% | E |
...
| ------------------- | -------------------- | -------------------- | ------------------ | ------ |
| Sobrecarga grupo de WhatsApp FAQ | Este grupo se creó para ayudar a los miembros del grupo a aclarar preguntas cortas durante el desarrollo del proyecto, pero últimamente se ha estado usando en exceso, y las preguntas se perdían en el chat. | Se ha avisado por la comunidad del correcto uso del grupo, y se ha pedido volver al estado inicial del grupo para que su uso sea el deseado | Con el paso del tiempo, los miembros del grupo pueden volver a la misma situación debido al estrés del desarrollo. | Cerrado |
| Despliegue continuo | No existía un despliegue continuo implementado de forma automática, se tenía que hacer a mano por varios integrantes del equipo, lo que llevaba a gran pérdida de tiempo.| Se ha realizado un workflow para realizar CI de forma automática. | S3-back y S3-front | Cerrado | 
| Servidor de correo | En el despliegue, la APi de correos, se bloquea el servidor de correo SMTPS debido al puerto, por lo que se inhiben las comunicaciones por correo bloqueando la aplicación al intentar enviar un correo automático. | Utilizar una nueva API en otro entorno, que se ha decantado por usar Azure que permita una configuración de red con el puerto 25 como salida.  | RIG-011 | Cerrado | 
...
- **Horas realizadas:** 199h 26min
- **Causa principal:** Finalizar de la mejor forma el trabajo del Sprint
- **Impacto:** X
- **Medidas futuras:** X

![Reloj de avance del proyecto](/.img/reloj_de_avance_proyecto_03-04-2025.png)
