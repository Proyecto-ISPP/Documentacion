...
| ALBERTO CARMONA SICRE (Secretario General) | DELFÍN SANTANA RUBIO                  | FRANCISCO MATEO VILLALBA               |
...
|------------------------------|--------------------------------|--------------------------------|---------------------------------------|-----------------------------|
| PABLO FERNÁNDEZ PÉREZ        | PABLO FERNÁNDEZ PÉREZ         | JULEN REDONDO PACHECO        | ALBERTO CARMONA SICRE (Secretario General) | FRANCISCO MATEO VILLALBA  |
...
| FRANCISCO MATEO VILLALBA     | RAMÓN GAVIRA SÁNCHEZ         |                                |                                       |                             |
...
- ✅ **Conclusión 5:** Las tareas para la próxima semana, con su debida asignación, han quedado acordadas de la siguiente forma:
  ...
  - **Product mock-ups de los UC**: FRANCISCO MATEO VILLALBA, FRANCISCO CAPOTE GARCÍA.
