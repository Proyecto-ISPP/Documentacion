...
| Tema 3 | Tras elaborar la idea más en profundidad se procedió a una lluvia de ideas (_brainstorming_) haciendo uso de la pizarra. Se decidió el nombre de "**_GALLERY GUIDE_**" para el proyecto.                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
![Pizarra grupal usada para las distintas dinámicas de la reunión](../../../static/.img/reunion_03-02-2024.png)
...
Las tareas a realizar serían, '_grosso modo_':
