---
title: "Sprint Retrospective - GRUPO 1"                    # CHANGE IF NEEDED
...
<p align="center" style={{ fontSize: "30px", fontWeight: "bold" }}>
  FISIO FIND - SPRINT RETROSPECTIVE - GRUPO 1
</p>
...
|------------|---------|----------------------------------|----------------------------|
| 27/03/2025 | v1.0    | Alberto Carmona Sicre, Rafael Pulido Cifuentes           | Elaboración de la retrospectiva. |
...
|--------|------------|--------------|
| 🔵 Aumentar las integraciones en las ramas principales para mejorar la colaboración. | Todo el grupo | Cada tres días durante el Sprint (Si se ha trabajado) |
| 🔵 Mejorar la coordinación para evitar solapamiento de tareas | Todo el grupo | Cada semana |
