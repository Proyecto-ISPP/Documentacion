...
subtitle: "FISIO FIND"
author: [Daniel Vela Camacho, Delfín Santana Rubio] # CHANGE IF NEEDED
...
Debido a dificultades en la definición del MVP, especialmente en la selección de los casos de uso _core_, el proyecto ha sido replanteado. Ahora, su enfoque se centra en un sistema de comisiones de arte, permitiendo a artistas particulares gestionar encargos personalizados.
...
- **_Dificultades en la legibilidad_** de la presentación desde distintos puntos del aula.
...
- **_Buen discurso introductorio en la presentación._**

- **_Fluidez en la conexión entre ideas presentadas._**
...
- Se sugiere **_omitir el índice_** en la presentación para mejorar la fluidez.

- Es fundamental definir con precisión los casos de uso _core_.
...
- **_Optimizar los colores y tamaños de fuente_** para mejorar la legibilidad.
...
- Es necesario **_revisar los costos y su estructura_**.
...
- Buen _elevator pitch_, logrando captar el interés rápidamente.
...
- Para atraer inversores, es clave presentar una **_visión clara de las herramientas especializadas_** de la aplicación.
...
- **_Documentar detalladamente los costos_**, incluso si no se presentan con el mismo nivel de detalle.
...
- Análisis más exhaustivo de los riesgos, comentando causas, consecuencias y estrategidas para solucionarlos. No centrarse tanto en riesgos vanales.
