...
- **Development Team**: Desarrolla el producto en iteraciones llamadas _sprints_.
...
![Desarrollo de la metodología Scrum](../../../static/.img/scrum.png)
...
![Fases de un proyecto según PMBOK](../../../static/.img/pmbok_phases_02.png)

![Intensidad de las fases de un proyecto según PMBOK](../../../static/.img/pmbok_phases_01.png)

### Tabla de procesos

![Tabla de procesos según PMBOK](../../../static/.img/pmbok_process_table.png)

### Áreas de conocimiento

![Áreas de conocimiento de PMBOK](../../../static/.img/pmbok_knowledge_fields.png)
...
_Software Project Management For Dummies_ establece **9 razones** principales por las que puede fallar un proyecto:
...
![El manifiesto agil](../../../static/.img/agile_principles.png)
...
![Pirámide de Maslow](../../../static/.img/mashlow_piramid.png)

### Teoría de la autodeterminación

![Teoría de la autodeterminación](../../../static/.img/autodetermination_theory.png)
...
Para elaborar un buen _Plan de Gestión de la Comunicación_ nos debemos preguntar:
